...
from .utils.dataset import read_scannet_gray, read_scannet_depth, read_scannet_pose
...
class ScanNetDataset(utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image0 = read_scannet_gray(
            img_name0, resize=(640, 480), augment_fn=self.augment_fn
        )
        image1 = read_scannet_gray(
            img_name1, resize=(640, 480), augment_fn=self.augment_fn
        )
